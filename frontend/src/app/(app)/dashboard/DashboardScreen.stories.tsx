...
// `InsightTeaserCard`, is reviewed in both of its states; this story carries only the ready one,
// matching a screen that has generated a set - the same division `Shell/Spending trend` and
// `Screens/04 Dashboard` already draw for the other cards.
//
